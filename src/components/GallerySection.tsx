    ...
    <section id="galería" className="section-padding bg-secondary/50">
      <div className="max-w-7xl mx-auto">
        ...
        <blockquote
          ...
          data-instgrm-permalink="https://www.instagram.com/p/DSXySUWjD7m/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          style={{
            ...
            padding: '0',
            width: '99.375%',
            // width: '-webkit-calc(100% - 2px)', React styles prefer simpler standard CSS or requires dropping vendor prefixes/using strings properly
          }}
        >
          <div style={{ padding: '16px' }}>
            <a
              href="https://www.instagram.com/p/DSXySUWjD7m/?utm_source=ig_embed&amp;utm_campaign=loading"
              style={{
                background: '#FFFFFF',
                lineHeight: '0',
                padding: '0 0',
            ...
            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: '0', marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              <a
                ...
                rel="noopener noreferrer"
              >
                Una publicación compartida de BURBUXA’S BARCELONA (@burbuxasbarcelona_)
              </a>
            </p>
          </div>
        </blockquote>
